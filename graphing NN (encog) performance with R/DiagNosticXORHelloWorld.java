 ...
 * 
 */
public class DiagNosticXORHelloWorld {
	...
	public static void main(final String args[]) {
		BufferedWriter out;
		try {
			out = new BufferedWriter(new FileWriter("nnstudy.csv"));

			//out.append(numberOfLayers + ","+ hiddenUnits + "," + epoch);
			out.write("layers,hiddenUnits,epochs\n");
			//out.write(textToSave);


			System.out.println();
			for (int run = 0; run < 100; run ++ ){
				for (int hiddenUnits = 3; hiddenUnits < 100; hiddenUnits++) {
					for (int numberOfLayers = 1; numberOfLayers < 6; numberOfLayers++) {
						...
						//System.out.println(numberOfLayers + ","+ hiddenUnits + "," + epoch);
						out.append(numberOfLayers + ","+ hiddenUnits + "," + epoch + "\n");
